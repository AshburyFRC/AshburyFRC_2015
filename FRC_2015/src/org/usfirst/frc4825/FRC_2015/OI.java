...
public class OI {
	...
	public JoystickButton suckForwButton, suckBackButton;
	...
	public OI() {
		...
		button8.whileHeld(new GoToNearTote());
		
		suckForwButton = new JoystickButton(joystick, 10);
		suckForwButton.whenPressed(new ToggleSuckForward());

		suckBackButton = new JoystickButton(joystick, 9);
		suckBackButton.whenPressed(new ToggleSuckBackward());
