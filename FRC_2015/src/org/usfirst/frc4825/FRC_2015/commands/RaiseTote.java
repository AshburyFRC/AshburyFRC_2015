...
public class RaiseTote extends Command {
	...
	protected void initialize() {
		System.out.println("Initialize RaiseTote"); //Print for debug
	}

	// Called repeatedly when this Command is scheduled to run
	@Override
	protected void execute() {
		Robot.toteLift.raiseTote(); //Call raiseTote() in toteLift subsystem to raise the tote
	}
	...
	@Override
	protected void end() {
		System.out.println("End RaiseTote"); //Print for debug
