...
public class RobotMap {
	...
	public static void init() {
		...
		driveTrainLeftSpeedController = new Victor(0);
		LiveWindow.addActuator("Drive Train", "Left Speed Controller",
				(Victor) driveTrainLeftSpeedController);

		driveTrainRightSpeedController = new Victor(1);
		LiveWindow.addActuator("Drive Train", "Right Speed Controller",
				(Victor) driveTrainRightSpeedController);
